                  ...
                  <tbody>
                    ...
                    try{
                        ...
                        <tr>
                            ...
                            <td>$<?php echo $row["edad_estudiante"] ?></td>
                            <td>
                                <a href="#editp_<?php echo $row['id_estudiante']; ?>" class="edit" data-toggle="modal"><i class="material-icons" title="Edit">&#xE254;</i></a>

                                <a href="#delete_<?php echo $row['id_estudiante']; ?>" class="delete" data-toggle="modal"><i class="material-icons" title="Delete">&#xE872;</i></a>
                            </td>
                            <?php include('mod.php'); ?>
                        </tr>
                    <?php
