...
<html lang="es">
  ...
  <?php
  include("vista/partials/navbar.php");

  include("vista/partials/sidebar.php");
  ?>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="vista/facturas.php" style="cursor:pointer;" class="small-box-footer">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="vista/productos.php" style="cursor:pointer;" class="small-box-footer">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="#" style="cursor:pointer;" class="small-box-footer">
                More info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
